...
Fluid is the latest version of PaddlePaddle, which describes the "process" of training
or inference using concept of model.
...
- Intended audience
    ...
    Peopol who are interested in know the deep learning system architecture.
